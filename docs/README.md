...
Issue #2 的首个纵向切片已建立十一项 Skill 目录、`dnd-5e` 统一进程门面、固定战役工作区、根清单和 SQLite 权威状态库边界，并支持安全创建与重新打开空战役。Issue #4 增加了完整三宝书开发构建、固定 Markdown 资产查询、本地预览打包和授权状态门禁。运行方式见仓库根目录的 [README.md](../README.md)。
